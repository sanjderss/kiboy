        ...
        if await group.is_visible():
            ...
            for i in range(count):
                ...
                if box and box['width'] > 50 and box['height'] > 100:
                    ...
                    print("Mengambil screenshot layar virtual phone...")
                    await page.screenshot(path="/home/codespace/.gemini/antigravity-cli/brain/4acaa28c-19c7-4065-a223-427ee91cae51/scratch/virtual_phone.png")
                    
                    print("--- STRUKTUR HTML LAYAR VIRTUAL PHONE ---")
                    html = await page.evaluate("""() => {
                        const arr = Array.from(document.querySelectorAll('canvas, video, button, .control-bar, .menu, img'));
                        return arr.map(e => e.outerHTML.substring(0, 200)).join('\\n\\n');
                    }""")
                    print(html)
                    break
