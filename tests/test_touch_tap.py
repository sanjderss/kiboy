        ...
        if await group.is_visible():
            ...
            for i in range(count):
                ...
                if box and box['width'] > 50 and box['height'] > 100:
                    ...
                    print("Mencoba touch tap area tengah layar (X:215, Y:466)...")
                    # Using touchscreen tap instead of mouse click
                    await page.touchscreen.tap(215, 466)
                    await asyncio.sleep(8)
                    
                    print("Mengambil screenshot SETELAH touch tap...")
                    await page.screenshot(path="/home/codespace/.gemini/antigravity-cli/brain/4acaa28c-19c7-4065-a223-427ee91cae51/scratch/virtual_phone_after_tap.png")
                    break
