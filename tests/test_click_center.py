        ...
        if await group.is_visible():
            ...
            for i in range(count):
                ...
                if box and box['width'] > 50 and box['height'] > 100:
                    ...
                    print("Mencoba klik area tengah layar (X:215, Y:466)...")
                    await page.mouse.click(215, 466)
                    await asyncio.sleep(5)
                    
                    print("Mengambil screenshot SETELAH klik tengah...")
                    await page.screenshot(path="/home/codespace/.gemini/antigravity-cli/brain/4acaa28c-19c7-4065-a223-427ee91cae51/scratch/virtual_phone_after_click.png")
                    break
