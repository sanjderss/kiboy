        ...
        if await group.is_visible():
            ...
            for i in range(count):
                ...
                if box and box['width'] > 50 and box['height'] > 100:
                    ...
                    print("Mengambil screenshot TANPA klik iframe, mengandalkan autoplay...")
                    await page.screenshot(path="/home/codespace/.gemini/antigravity-cli/brain/4acaa28c-19c7-4065-a223-427ee91cae51/scratch/autoplay_test.png")
                    break
